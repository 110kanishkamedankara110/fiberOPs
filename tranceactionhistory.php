...
?>
    ...
    <head>
        <title>FIBEROPTICSLK | Purchase History</title>
        <meta charset="utf-8">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-12">
                                                    <p>Order Status</p>
                                                    <?php
                                                    $q = "SELECT * FROM `order_status` WHERE `invoice_id`='" . $da["id"] . "' ORDER BY `time` DESC";
                                                    $resst = database::s($q);
                                                    ...
                                                    ?>
                                                            ...
                                                            <span class="fw-bold text-black"><?= $rowstat["time"] ?>
                                                                <br />
                                                            <?php
                                                        }
                                                    } else {
