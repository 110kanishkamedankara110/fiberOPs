...
?>
    ...
    <head>
        <title>FIBEROPTICSLK | Watchlist</title>
                ...
                <div class="col-12 py-2 rounded">
                    <div class="row">
                        <div class="col-12 px-4">
                            <label class="form-label fs-5 fw-bolder">Watchlist <li class="fa fa-heart text-danger"></li> </label>
                        </div>
                        <!-- <div class="col-12">
                            <div class="row">
                            ...
                            ?>
                                ...
                                for ($i = 0; $i < $nrwl; $i++) {
                                    ...
                                    INNER JOIN `condition` ON `condition`.`id`=`product`.`condition_id` 
                                     WHERE `product`.`id`='" . $pro["product_id"] . "';");
