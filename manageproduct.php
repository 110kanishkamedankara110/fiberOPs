        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="products">
                    ...
                    <div class="col-12">
                        <h3 class="text-white bg-dark">Manage Models</h3>
                    </div>
                                ...
                                <div class="row g-1 px-1">
                                    <div class="col-12 text-center bg-body border border-2 border-danger shadow rounded">
                                        <div class="row">
                                            <div class="col-2 mt-3 addnewimg"></div>
                                            <div class="col-10">
                                                <label class="form-label fs-4 fw-bold py-3 text-black-50" onclick="addnewmod();">Add New Model</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-1 px-1">
                                    <div class="col-12 text-center bg-body border border-2 border-danger shadow rounded">
                                        <div class="row">
                                            <div class="col-2 mt-3 addnewimg"></div>
                                            <div class="col-10">
                                                <label class="form-label fs-4 fw-bold py-3 text-black-50" onclick="addnewbra();">Add New Brand</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="btn-close" data-bs-dismiss="addnewbra" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
