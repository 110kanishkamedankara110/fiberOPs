            ...
            <div class="row align-items-start p-0">
                ...
                <div class="col-12 col-md-9 p-0">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-dark px-3 py-2">
                        <h5 class="text-white m-0">Manage Brand</h5>
                    ...
                    <!-- addcolor -->
                    <div class="d-flex align-items-center justify-content-between bg-dark px-3 py-2">
                        <h5 class="text-white m-0">Manage Color</h5>
                        <div class="btn bg-white m-0">
                            <label class="form-label small fw-bold text-black-50 m-0" onclick="addnewcol();">Add New Color</label>
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="d-flex align-items-center justify-content-start flex-wrap g-1">
                            ...
                            $cat = database::s("SELECT * FROM `color`");
                            $num = $cat->num_rows;
                            for ($i = 0; $i < $num; $i++) {
                                $c = $cat->fetch_assoc();
                            ?>
                    ...
                    <div class="modal fade" id="addnewcol" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <input id="col" type="text" class="form-control" placeholder="Brand" />
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-primary" onclick="addcol();">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
